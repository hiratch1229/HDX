...
void    ImGui_ImplWin32_NewFrame()
{
  ...
  io.DisplaySize = ImVec2(static_cast<float>(hdx::System::GetWindowWidth()), static_cast<float>(hdx::System::GetWindowHeight()));
  ...
  io.KeyCtrl = hdx::Input::Keyboard::KeyControl.Press();
  io.KeyShift = hdx::Input::Keyboard::KeyShift.Press();
  io.KeyAlt = hdx::Input::Keyboard::KeyAlt.Press();
  io.KeySuper = false;
