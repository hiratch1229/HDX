...
public:
  ...
  virtual void Draw(const hdx::Model& _Model, const hdx::Matrix& _WorldMatrix, const std::vector<hdx::MotionBlendData>& _MotionBlendDatas, const hdx::ColorF& _Color) = 0;
